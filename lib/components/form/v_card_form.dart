...
class VcardForm extends StatefulWidget {
  const VcardForm({Key? key}) : super(key: key);
...
class _VcardFormState extends State<VcardForm> {
  ...
  _generateVCard() {
    ...
    //validation
    if(firstNameTextEditingController.text.isEmpty || emailTextEditingController.text.isEmpty && cellPhoneTextEditingController.text.isEmpty){
      dialogHelper.showMessageOnlyAlertDialog(context, 'Please fill atleast Phone, Email and First Name', 'Error');
      return;
    }
  ...
  TextEditingController  organizationTextEditingController= TextEditingController();
  TextEditingController  workPhoneTextEditingController= TextEditingController();
  ...
  TextEditingController  cellPhoneTextEditingController = TextEditingController();

  //qr ctext controller
  TextEditingController _qrTopDecorationTextEditingController = TextEditingController();
